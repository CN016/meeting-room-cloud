package meeting.room.meetingroomcloud;
...
public class CodeGeneration {
    public static final String URL = "www.016imcn.love:3306";
    public static final String DB = "meeting-room";
    public static final String USER = "root";
    public static final String PASSWD = "MySql@016016";
    public static final String BeanName = "meeting.room";
    ...
    DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://" + URL + "/" +DB+"?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai",USER,PASSWD)
    ...
    PackageConfig packages = new PackageConfig.Builder()
            .entity("entity")//实体类包名
            .parent(BeanName)//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
